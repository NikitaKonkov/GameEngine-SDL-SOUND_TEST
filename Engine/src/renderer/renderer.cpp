...
void Renderer::pickPhysicalDevice() {
    ...
    physicalDevice = devices[0]; // Just use the first device
...
void Renderer::createSwapChain() {
    ...
    surfaceFormat = formats[0]; // Just use the first format
...
void Renderer::createShaderModules() {
    ...
    vertShaderModule = Shader::createShaderModule(device, vertexShaderCode);
    fragShaderModule = Shader::createShaderModule(device, fragmentShaderCode);
}
